view: Internet_Sales_Cube {
    ...
    sql_table_name: "Sales_Insights_Snowflake"."Internet_Sales_Cube";;
    ...
    dimension: Customer_Hierarchy_Customer_Name {
        ...
        group_label: "Customer Attributes.Customer Hierarchy"
        type: string
        sql: ${TABLE}.`Customer Name`;;
    }

    dimension: Customer_Hierarchy_Geography_Key_LVL {
        label: "  Geography Key LVL"
        group_label: "Customer Attributes.Customer Hierarchy"
        type: number
        sql: ${TABLE}.`Geography Key LVL`;;
        drill_fields: [Customer_Hierarchy_Customer_Name]
    }
    ...
    measure: salesamount1 {
        label: "Sales Amount"
        group_label: "Sales Metrics"
        description: "Sum(factinternetsales.salesamount) sample desc"
        value_format: "$#,##0.00"
        drill_fields: [Customer_Details*,Shipping_Details*]
        type: sum
